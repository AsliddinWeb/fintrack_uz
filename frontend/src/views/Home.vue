          ...
          <div class="flex flex-col lg:pb-6">
            ...
            <div class="mt-10 flex flex-wrap gap-4">
              ...
              ><a
                ...
                class="inline-flex justify-center rounded-lg text-sm font-semibold py-3 px-4 bg-white/0 text-slate-900 ring-1 ring-slate-900/10 hover:bg-white/25 hover:ring-slate-900/15 whitespace-nowrap"
                target="_blank"
                ><span
                  >Xarajatlar
                  <span aria-hidden="true" class="text-black/25">→</span></span
                ></a
              >
            </div>
          </div>
...
export default {
  ...
  async created() {
    try {
      const response = await axios.get('https://your-backend-api-url/finance-data')
